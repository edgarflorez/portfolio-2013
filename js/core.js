...
(function($, window, document) {
    ...
    function configWorkDetailLayout(isResize){
        var config                  = {
        ...
        if(isResize){
            ...
            galleryCarrousel.stop().animate({left: '0' }, 500, function(){
    ...
    function configWorksMenuUI(){
        ...
        function configWorkDetailUI(article){
            ...
            galleryCarrousel.find('img').load(function(){

                if(galleryCarrousel.find('img').index($(this)) == numItems -1){
                    galleryConfig();
                };
            })
            ...
            function gallerySwipeMoveTo(direction){
                ...
                galleryNav.find('.gallery-nav-button').eq(index).trigger('click')
